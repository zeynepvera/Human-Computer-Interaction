...
public class MainPage extends javax.swing.JFrame {
    ...
    public MainPage(LibraryController controller) {
    ...
    private void initComponents() {
        ...
        jButton4.setText("You already have account?");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        new Login(controller).setVisible(true); // Login ekranını aç
    ...
    private void registerbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerbuttonActionPerformed
        ...
        this.dispose(); // Bu pencereyi kapat
        new Register(controller).setVisible(true); // Register ekranını aç
